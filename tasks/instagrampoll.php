				...
				foreach($media as $med) 
				{
					...
					$image = \DB::select('instagram_id')
						...
						if($content_type == 'application/xml' and $xml = new \SimpleXMLElement($output))
						{
							...
							{						
								throw new ImageAccessDeniedException("Access denied to 'http://distilleryimage0.s3.amazonaws.com/47040426c57211e2880f22000a1f9ca7_5.jpg'. This entry hasn't been saved to the DB.");
							}
...
class ImageAccessDeniedException extends \Exception {}
